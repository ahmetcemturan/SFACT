...
def removeChildNodesFromElementObject(xmlElement):
	'Process the xml element by manipulationFunction.'
	xmlElement.removeChildNodesFromIDNameParent()
	if xmlElement.xmlObject != None:
		if xmlElement.parentNode.xmlObject != None:
			if xmlElement.xmlObject in xmlElement.parentNode.xmlObject.archivableObjects:
				xmlElement.parentNode.xmlObject.archivableObjects.remove(xmlElement.xmlObject)

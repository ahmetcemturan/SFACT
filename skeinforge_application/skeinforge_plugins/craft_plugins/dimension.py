...
#		((self.restartDistance * self.retractionRatio) - (self.restartDistance * self.retractionRatio)* self.autoRetractDistance)
		...
		if self.repository.maxZFeedRate.value != None and self.travelFeedRatePerSecond != None:
			self.zDistanceRatio = self.travelFeedRatePerSecond / (self.repository.maxZFeedRate.value /60) #self.maximumZTravelFeedRatePerSecond
			#print (self.zDistanceRatio,self.travelFeedRatePerSecond,self.repository.maxZFeedRate.value)

...
class SkinSkein:
	...
	def addSkinnedInfill(self):
		...
		self.addFlowRateLine(0.25 * self.repository.infillBottomFlowRate.value * self.oldFlowRate)
		self.addInfillOutlines(self.repository.infillBottomFeedRate.value * self.feedRateMinute, infillOutlines, lowerZ)
		self.addFlowRateLine(0.25 * self.repository.infillTopFlowRate.value * self.oldFlowRate)

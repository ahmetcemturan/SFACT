...
class EaseSkein:
	...
	def addEasenedPerimeter(self):
		...
		outerPerimeter = intercircle.getLargestInsetLoopFromLoop(self.perimeter, self.perimeter)#		outerPerimeter = intercircle.getLargestInsetLoopFromLoop(self.perimeter, -self.quarterPerimeterWidth)

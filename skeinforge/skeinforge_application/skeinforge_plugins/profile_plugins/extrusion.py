...
def getCraftSequence():
	...
	return 'carve scale bottom preface inset fill multiply speed temperature raft skirt chamber jitter clip stretch leadin skin comb cool wipe lash limit dimension export'.split()
